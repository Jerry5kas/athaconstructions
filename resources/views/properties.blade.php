                                    ...
                                    <a href="{{ route('properties.show', $property->slug) }}" class="block">
                                        ...
                                        <div class="relative overflow-hidden bg-gray-100">
                                            @if($property->featured_image)
                                                ...
                                                >
                                            @else
                                                <div class="relative w-full h-64 bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
                                                    <div class="absolute inset-0 bg-black/30"></div>
                                                    <svg class="relative z-10 w-12 h-12 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
