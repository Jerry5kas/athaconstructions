...
>
    {{-- Page Banner --}}
    <section class="relative h-64 md:h-80 bg-cover bg-center" style="background-image: url('{{ asset('images/contact-us.jpg') }}')">
        <div class="absolute inset-0 bg-black/50"></div>
        <div class="container mx-auto px-4 h-full flex items-center justify-center relative z-10">
            <h1 class="font-tenor text-3xl md:text-4xl text-white uppercase">Contact Us</h1>
        </div>
    </section>
